...
1. ![](blue_15x15.png) Объект в котором хранятся запрашиваемые записи
2. ![](green_15x15.png) Название таблицы из которой берутся записи. Все записи созданы по одному шаблону, и могут содержать только те поля, которые содержатся в шаблоне.
3. ![](red_15x15.png) Логическое условие
4. ![](violet_15x15.png) Сортировка записей
5. ![](dark-green_15x15.png) Результат запроса, объект с отфильтрованными записями
